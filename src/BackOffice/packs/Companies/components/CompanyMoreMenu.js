...
export default function CompanyMoreMenu(props){
  ...
  const { callbacks: { deleteCompany } } = useContext(PageContext)
    ...
    <>
      ...
      >
        ...
        <DialogActions>
          ...
          <Button onClick={() => deleteCompany(company)} autoFocus variant="contained" color="primary">
            Yes, delete it.
          </Button>
        </DialogActions>
      </Dialog>
      ...
      >
        ...
        <MenuItem component={RouterLink} to={`/dashboard/companies/${company.id}`} sx={{ color: 'text.secondary' }}>
          <ListItemIcon>
